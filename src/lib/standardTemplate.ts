 ...
 */
export const createStandardTemplate = (
  data: object,
  token: string,
): Promise<object> => {
 ...
 * @returns {Promise<object>}
 */
export const deleteStandardTemplate = (
  id: number,
  comments: string,
  token: string,
): Promise<object> => {
  ...
  return new Promise((resolve, reject) => {
    const request = client.delete(`/api/v1/standardtemplates/`, {
      headers: { authorization: token },
      data: data,
    });
    request
 ...
 * @returns {Promise<object>}
 */
export const discardStandardTemplateChanges = (
  id: string,
  token: string,
): Promise<object> => {
  return new Promise((resolve, reject) => {
    const data = {};
    const request = client.get(`/api/v1/standardtemplates/discard/${id}`, {
      headers: { authorization: token },
      data: data,
    });
    request
 ...
 * @returns {Promise<object>}
 */
export const getStandardTemplateInformationById = (
  id: string,
  version: string,
  ...
  return new Promise((resolve, reject) => {
    const confirmationRequest = client.get(
      `/api/v1/standardtemplates/${id}/${version}/${returnNullIfVersionNotFound}`,
      {
        headers: { authorization: token },
      },
    );
 ...
 * @returns {Promise<object>}
 */
export const getStandardTemplateList = (
  filter: string[],
  version: string,
 ...
 * @returns {Promise<object>}
 */
export const publishStandardTemplate = (
  id: number,
  comments: string,
  token: string,
): Promise<object> => {
  return new Promise((resolve, reject) => {
    ...
    if (comments) data.comments = comments;
    const confirmationRequest = client.post(
      `/api/v1/standardtemplates/publish/${id}`,
      data,
      {
        headers: { authorization: token },
      },
 ...
 * @returns {Promise<object>}
 */
export const setStandardTemplateInformation = (
  id: string,
  data: object,
  token: string,
): Promise<object> => {
  return new Promise((resolve, reject) => {
    ...
    const confirmationRequest = client.post(
      `/api/v1/standardtemplates/update`,
      requestData,
      {
        headers: { authorization: token },
      },
 ...
 * @returns {Promise<object>}
 */
export const setStandardTemplateTags = (
  id: string,
  tags: object,
  token: string,
): Promise<object> => {
  return new Promise((resolve, reject) => {
    ...
    const confirmationRequest = client.post(
      `/api/v1/standardtemplates/updatetags`,
      requestData,
      {
        headers: { authorization: token },
      },
